...
save(get_tex, get_gof, get_vif, get_lh, get_missing, get_glh, file = "table_functions.RData")
...
save(mytex, mygof, goflist, outcome, file = "table_soc.RData")

# Save the best fit model at the end, because it's enormous.
m9 %>% saveRDS("model_soc.RData")
...
save(mytex, mygof, goflist, outcome, file = "table_dev.RData")

# Save the best fit model at the end, because it's enormous.
m9 %>% saveRDS("model_dev.RData")
...
save(mytex, mygof, goflist, outcome, file = "table_mid.RData")

# Save the best fit model at the end, because it's enormous.
m9 %>% saveRDS("model_mid.RData")
...
get_ktable = function(tableno){
  ...
  tab %>%
    ...
    add_header_above(header = c(" ", "Model 1" = 1, "Model 2" = 1, "Model 3" = 1, "Model 4" = 1,
                                "Model 5" = 1, "Model 6" = 1, "Model 7" = 1, "Model 8" = 1)) %>%
...
save(mycoefnames, mycolumns, get_ktable, file = "captions.RData")
```

## Table

```{r}
load("table_soc.RData")
load("captions.RData")
...
m9 <- read_rds("model_soc.RData")
load("table_functions.RData")
soc <- get_stat(m9)

m9 <- read_rds("model_dev.RData")
load("table_functions.RData")
dev <- get_stat(m9)

m9 <- read_rds("model_mid.RData")
load("table_functions.RData")
mid <- get_stat(m9)
...
save(get_simrange_mi, get_simrange, get_sim, get_dist, myconstants,
     ...
     file = "simulator.RData")
```


```{r}
load("simulator.RData")
m9 <- read_rds("model_soc.RData")
